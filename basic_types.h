...
#ifndef CROSSFIELD__BASIC_TYPES_H_
#define CROSSFIELD__BASIC_TYPES_H_
...
struct ArrayHash {
  size_t operator()(const T &key) const {
    ...
    for (int n = 0; n < len; ++n) {
      //const unsigned char* p = static_cast<const unsigned char*>(key[n]);
...
#endif //CROSSFIELD__BASIC_TYPES_H_
